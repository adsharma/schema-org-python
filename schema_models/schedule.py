...
class Schedule(Intangible):
    ...
    byDay: Optional[Union["DayOfWeek", List["DayOfWeek"], str, List[str]]] = None
    ...
    exceptDate: Optional[Union[date, List[date], datetime, List[datetime]]] = None
    repeatCount: Optional[Union[int, List[int]]] = None
    repeatFrequency: Optional[Union[Duration, List[Duration], str, List[str]]] = None
